...
<body class="hold-transition login-page">
	...
	<div class="login-box">
		...
		<div class="login-box-body">
			<p class="login-box-msg">Houve um formato errado de dados.
				Verifique os campos e tente novamente.</p>
			...
			<div class="row">
				...
				<button  type="button" class="btn btn-success btn-block btn-flat">Página Inicial</button></a>  --%>
				</div>
				<div class="col-xs-3"></div>
